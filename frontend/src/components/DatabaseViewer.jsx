...
const DatabaseViewer = ({ onClose }) => {
  ...
  // ✅ Make table expand horizontally and scroll
  const tableStyle = {
    width: "max-content",     // << key fix: do NOT squeeze columns
    minWidth: "100%",         // still fill the panel if small
    borderCollapse: "collapse",
  };

  // ✅ Header should NOT wrap (prevents vertical stacked text)
  ...
  // Body can wrap (or change to nowrap if you prefer)
  const bodyCellStyle = {
    whiteSpace: "normal",
    ...
    padding: "8px 10px",
    verticalAlign: "top",
    maxWidth: 420, // prevents extremely wide text cells from taking over
  };
        ...
        <div className="modal-header">
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div className="modal-subtitle">View actual table rows (SELECT * …)</div>
            </div>
          </div>
                ...
                >
                  <table className="table" style={tableStyle}>
                    ...
                    <tbody>
                      {loadingTable ? (
                        <tr>
                          <td colSpan={columns.length} style={bodyCellStyle}>
                            Loading rows…
                          </td>
                        </tr>

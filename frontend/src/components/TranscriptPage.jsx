    ...
    <>
      ...
      <div className="shell">
        ...
        <div className="card" style={{ padding: 18, marginBottom: 16 }}>
          ...
          <div className="panel-body" style={{ minHeight: 90, whiteSpace: "pre-wrap" }}>
            {data?.transcript_summary || "No summary yet. This appears after analysis completes."}
          </div>
        </div>
          ...
          {transcriptText ? (
            <div
              style={{
                ...
                wordBreak: "break-word",         // ✅ nice for long text
              }}
            >
              {transcriptText}
            </div>
...
const KV = ({ k, v }) => (
  ...
  >
    ...
    <div style={{ color: "#1F2937", fontFamily: "var(--font-mono)", fontSize: 12 }}>
      {v}
    </div>
  </div>
);
